          ...
          <div className="mt-6">
            ...
            <div className="flex justify-center">
              <button
                ...
                className="w-full max-w-[320px] py-4 bg-white border border-slate-200 rounded-full font-black uppercase tracking-widest text-[10px] flex items-center justify-center gap-3 hover:bg-slate-50 transition-all shadow-sm"
              >
